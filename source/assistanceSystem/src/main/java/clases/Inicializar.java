...
public class Inicializar {
    ...
    Grupo g1 = new Grupo(cur1,1,101,30,doc1);
    Grupo g2 = new Grupo(cur2,2,102,30,doc2);
    Grupo g3 = new Grupo(cur3,1,204,30,doc3);
    Grupo g4 = new Grupo(cur4,2,207,30,doc4);
    Grupo g5 = new Grupo(cur5,1,105,30,doc5);
    Grupo g6 = new Grupo(cur6,2,103,30,doc6);
    Grupo g7 = new Grupo(cur7,1,201,30,doc7);
    ...
    Administrativo ad1 = new Administrativo("25505151","Ines Zapata","Ines","401", a1,"900");
    Administrativo ad2 = new Administrativo("25505152","Alberto Martines","Alberto","402", a2,"901" );
    Administrativo ad3 = new Administrativo("25505153","Jorge Alarcon","Jorge","403", a3,"902" );
    Administrativo ad4 = new Administrativo("25505154","Andres Perez","Andres","404", a4,"903" );
    Administrativo ad5 = new Administrativo("25505155","Maria Lopez","Maria","405", a5,"904" );
}
...
/*Alumno alu = new Alumno();;
    ...
    public void aluRegistrado(){
    	String nom[] = {"Carlos Quispe","Maria Sanchez","Jordy Villazana","Rocio Salcedo","Karla Correa","Oscar Rosales","Mirya Huachua","Sergio Perez","Liset Montes"};
    	...
    	for(int i=0;i<alu.length;i++){
            alu[i] = new Alumno(dni[i],nom[i],cod[i],promocion[i]);
    	}
        } */